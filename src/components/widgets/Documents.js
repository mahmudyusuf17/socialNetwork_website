export default function Documents(){
    return(
        <div class="people-section pt-10">
            <h2 className="text-xl font-semibold">Documents</h2>
            <div class="grid grid-cols-3 gap-4 mt-2">
                <div class="xy-thumbnail row-span-3 col-span-2 relative cursor-pointer">
                    <img src="../assets/images/thumbnail.jpeg" alt="image thumbnail" className="brightness-50 hover:brightness-75 h-full" />
                    <div className="absolute w-full py-2.5 bottom-1 ml-4">
                        <p className="text-xl text-white font-bold">Mobile ui & ux guide 2022</p>
                        <div className="flex justify-between items-center text-sm text-white">
                            <p>by Sebastian Stan</p>
                            <p className="pr-8">500 views</p>
                        </div>
                    </div>
                </div>
                <div class="xy-thumbnail relative cursor-pointer">
                    ...
                    <div className="absolute w-full py-2.5 bottom-0 ml-4">
                        <p className="text-base text-white font-bold">HTML 5 and Usage</p>
                        <div className="flex justify-between items-center text-sm text-white">
                            <p>520 views</p>
                        </div>
                    </div>
                ...
                <div className="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed">
                      <div className="space-y-1 text-center">
                        <svg className="mx-auto h-12 w-12 text-gray-400 text-center"
                          stroke="currentColor"
                          fill="none"
                          viewBox="0 0 20 20"
